...
pub mod neural {
    ...
    pub mod google {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.da-DK-Wavenet-F")]
            WavenetF,
        }
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.da-DK-Wavenet-G")]
            WavenetG,
        }
    ...
    pub mod polly {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Polly.Sofie-Neural")]
            SofieNeural,
        }
...
pub mod standard {
    ...
    pub mod google {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.da-DK-Standard-F")]
            StandardF,
        }
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.da-DK-Standard-G")]
            StandardG,
        }
