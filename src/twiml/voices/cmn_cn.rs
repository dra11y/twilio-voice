...
pub mod generative {
    ...
    pub mod google {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Aoede")]
            Chirp3HdAoede,
            #[serde(rename = "Google.cmn-CN-Chirp3-HD-Kore")]
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Kore")]
            Chirp3HdKore,
            #[serde(rename = "Google.cmn-CN-Chirp3-HD-Leda")]
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Leda")]
            Chirp3HdLeda,
            #[serde(rename = "Google.cmn-CN-Chirp3-HD-Zephyr")]
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Zephyr")]
            Chirp3HdZephyr,
        }
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Charon")]
            Chirp3HdCharon,
            #[serde(rename = "Google.cmn-CN-Chirp3-HD-Fenrir")]
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Fenrir")]
            Chirp3HdFenrir,
            #[serde(rename = "Google.cmn-CN-Chirp3-HD-Orus")]
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Orus")]
            Chirp3HdOrus,
            #[serde(rename = "Google.cmn-CN-Chirp3-HD-Puck")]
            #[strum(to_string = "Google.cmn-CN-Chirp3-HD-Puck")]
            Chirp3HdPuck,
        }
...
pub mod standard {
    ...
    pub mod google {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.cmn-CN-Standard-A")]
            StandardA,
            #[serde(rename = "Google.cmn-CN-Standard-D")]
            #[strum(to_string = "Google.cmn-CN-Standard-D")]
            StandardD,
        }
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.cmn-CN-Standard-B")]
            StandardB,
            #[serde(rename = "Google.cmn-CN-Standard-C")]
            #[strum(to_string = "Google.cmn-CN-Standard-C")]
            StandardC,
        }
...
pub mod neural {
    ...
    pub mod google {
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.cmn-CN-Wavenet-B")]
            WavenetB,
            #[serde(rename = "Google.cmn-CN-Wavenet-C")]
            #[strum(to_string = "Google.cmn-CN-Wavenet-C")]
            WavenetC,
        }
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.cmn-CN-Wavenet-A")]
            WavenetA,
            #[serde(rename = "Google.cmn-CN-Wavenet-D")]
            #[strum(to_string = "Google.cmn-CN-Wavenet-D")]
            WavenetD,
        }
    ...
    pub mod polly {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Polly.Zhiyu-Neural")]
            ZhiyuNeural,
        }
