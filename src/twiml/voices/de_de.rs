...
pub mod standard {
    ...
    pub mod polly {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Polly.Marlene")]
            Marlene,
            #[serde(rename = "Polly.Vicki")]
            #[strum(to_string = "Polly.Vicki")]
            Vicki,
        }
    ...
    pub mod google {
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.de-DE-Standard-H")]
            StandardH,
        }
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.de-DE-Standard-G")]
            StandardG,
        }
...
pub mod neural {
    ...
    pub mod google {
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.de-DE-Neural2-H")]
            Neural2H,
            #[serde(rename = "Google.de-DE-Wavenet-H")]
            #[strum(to_string = "Google.de-DE-Wavenet-H")]
            WavenetH,
        }
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.de-DE-Neural2-G")]
            Neural2G,
            #[serde(rename = "Google.de-DE-Wavenet-G")]
            #[strum(to_string = "Google.de-DE-Wavenet-G")]
            WavenetG,
        }
    ...
    pub mod polly {
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Polly.Daniel-Neural")]
            DanielNeural,
        }
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Polly.Vicki-Neural")]
            VickiNeural,
        }
...
pub mod generative {
    ...
    pub mod polly {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Polly.Vicki-Generative")]
            VickiGenerative,
        }
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Polly.Daniel-Generative")]
            DanielGenerative,
        }
    ...
    pub mod google {
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Charon")]
            Chirp3HdCharon,
            #[serde(rename = "Google.de-DE-Chirp3-HD-Fenrir")]
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Fenrir")]
            Chirp3HdFenrir,
            #[serde(rename = "Google.de-DE-Chirp3-HD-Orus")]
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Orus")]
            Chirp3HdOrus,
            #[serde(rename = "Google.de-DE-Chirp3-HD-Puck")]
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Puck")]
            Chirp3HdPuck,
        }
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Aoede")]
            Chirp3HdAoede,
            #[serde(rename = "Google.de-DE-Chirp3-HD-Kore")]
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Kore")]
            Chirp3HdKore,
            #[serde(rename = "Google.de-DE-Chirp3-HD-Leda")]
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Leda")]
            Chirp3HdLeda,
            #[serde(rename = "Google.de-DE-Chirp3-HD-Zephyr")]
            #[strum(to_string = "Google.de-DE-Chirp3-HD-Zephyr")]
            Chirp3HdZephyr,
        }
