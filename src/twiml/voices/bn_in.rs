...
pub mod standard {
    ...
    pub mod google {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.bn-IN-Standard-A")]
            StandardA,
            #[serde(rename = "Google.bn-IN-Standard-C")]
            #[strum(to_string = "Google.bn-IN-Standard-C")]
            StandardC,
        }
        ...
        impl From<Female> for crate::twiml::Voice {
            fn from(value: Female) -> Self {
                Self::BnIn(super::super::Voice::Standard(super::Voice::Google(
                    Voice::Female(value),
                )))
            }
        }
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.bn-IN-Standard-B")]
            StandardB,
            #[serde(rename = "Google.bn-IN-Standard-D")]
            #[strum(to_string = "Google.bn-IN-Standard-D")]
            StandardD,
        }
...
pub mod generative {
    ...
    pub mod google {
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Charon")]
            Chirp3HdCharon,
            #[serde(rename = "Google.bn-IN-Chirp3-HD-Fenrir")]
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Fenrir")]
            Chirp3HdFenrir,
            #[serde(rename = "Google.bn-IN-Chirp3-HD-Orus")]
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Orus")]
            Chirp3HdOrus,
            #[serde(rename = "Google.bn-IN-Chirp3-HD-Puck")]
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Puck")]
            Chirp3HdPuck,
        }
        ...
        impl From<Male> for crate::twiml::Voice {
            fn from(value: Male) -> Self {
                Self::BnIn(super::super::Voice::Generative(super::Voice::Google(
                    Voice::Male(value),
                )))
            }
        }
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Aoede")]
            Chirp3HdAoede,
            #[serde(rename = "Google.bn-IN-Chirp3-HD-Kore")]
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Kore")]
            Chirp3HdKore,
            #[serde(rename = "Google.bn-IN-Chirp3-HD-Leda")]
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Leda")]
            Chirp3HdLeda,
            #[serde(rename = "Google.bn-IN-Chirp3-HD-Zephyr")]
            #[strum(to_string = "Google.bn-IN-Chirp3-HD-Zephyr")]
            Chirp3HdZephyr,
        }
...
pub mod neural {
    ...
    pub mod google {
        ...
        pub enum Female {
            ...
            #[strum(to_string = "Google.bn-IN-Wavenet-A")]
            WavenetA,
            #[serde(rename = "Google.bn-IN-Wavenet-C")]
            #[strum(to_string = "Google.bn-IN-Wavenet-C")]
            WavenetC,
        }
        ...
        impl From<Female> for crate::twiml::Voice {
            fn from(value: Female) -> Self {
                Self::BnIn(super::super::Voice::Neural(super::Voice::Google(
                    Voice::Female(value),
                )))
            }
        }
        ...
        pub enum Male {
            ...
            #[strum(to_string = "Google.bn-IN-Wavenet-B")]
            WavenetB,
            #[serde(rename = "Google.bn-IN-Wavenet-D")]
            #[strum(to_string = "Google.bn-IN-Wavenet-D")]
            WavenetD,
        }
